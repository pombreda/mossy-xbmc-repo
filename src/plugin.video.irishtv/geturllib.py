	...
	while repeat:
		...
		try:
			...
			if firstTime:
				...
				# , 'Timeout occurred two times in a row' 
				logException = LoggingException('_GetURL_NoCache', __language__(30865))

				# 'Socket timed out'/'Change the socket timeout in the plugin setting if you see this problem a lot'
				logException.process(__language__(30870), __language__(30860), logLevel )
				return None
